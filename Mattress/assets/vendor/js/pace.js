!function (t, e) {
    var n = function (t) {
        ...
        207: function (t, e, n) {
            ...
            var r, o;
            (function () {
                var i, s, a, u, l, c, p, h, d, f, g, m, y, v, w, b, k, S, L, x, q, T, j, P, O, R, M, _, A, E, N, C, F,
                    U, W, X, D, H, I, z, B, G, J, K, Q, V, Y, Z, $ = [].slice, tt = {}.hasOwnProperty,
                    et = function (t, e) {
                ...
                for (q = {
                    ...
                    return e = A(), (n = function () {
                        var r;
                        return (r = A() - e) >= 33 ? (e = A(), t(r, function () {
                            return N(n)
                        })) : setTimeout(n, 33 - r)
                    })()
                }, C = function () {
                    ...
                    var t, e, n, r, o, i, s;
                    for (e = arguments[0], r = 2 <= arguments.length ? $.call(arguments, 1) : [], i = 0, s = r.length; i < s; i++) if (n = r[i]) for (t in n) tt.call(n, t) && (o = n[t], null != e[t] && "object" == typeof e[t] && null != o && "object" == typeof o ? T(e[t], o) : e[t] = o);
                    return e
                }, k = function (t) {
                    var e, n, r, o, i;
                    ...
                    return t.prototype.on = function (t, e, n, r) {
                        ...
                        if (n = arguments[0], t = 2 <= arguments.length ? $.call(arguments, 1) : [], null != (s = this.bindings) ? s[n] : void 0) {
                            for (o = 0, u = []; o < this.bindings[n].length;) a = this.bindings[n][o], r = a.handler, e = a.ctx, i = a.once, r.apply(null != e ? e : this, t), i ? u.push(this.bindings[n].splice(o, 1)) : u.push(o++);
                            return u
                        }
                    }, t
                }(), f = window.Pace || {}, window.Pace = f, T(f, p.prototype), E = f.options = T({}, q, window.paceOptions, P()), J = 0, Q = (Y = ["ajax", "document", "eventLag", "elements"]).length; J < Q; J++) !0 === E[D = Y[J]] && (E[D] = q[D]);
                d = function (t) {
                    function e() {
                    ...
                    return t.prototype.trigger = function (t, e) {
                        ...
                        if (null != this.bindings[t]) {
                            for (i = this.bindings[t], s = [], r = 0, o = i.length; r < o; r++) n = i[r], s.push(n.call(this, e));
                            return s
                        }
                ...
                }(), G = window.XMLHttpRequest, B = window.XDomainRequest, z = window.WebSocket, j = function (t, e) {
                    var n, r;
                    ...
                    var t, e, n;
                    return e = arguments[0], t = 2 <= arguments.length ? $.call(arguments, 1) : [], M.unshift("ignore"), n = e.apply(null, t), M.shift(), n
                }, f.track = function () {
                    var t, e, n;
                    return e = arguments[0], t = 2 <= arguments.length ? $.call(arguments, 1) : [], M.unshift("track"), n = e.apply(null, t), M.shift(), n
                }, X = function (t) {
                    var e;
                    ...
                    function e() {
                        ...
                        if (null != z && E.ajax.trackWebSockets) {
                            window.WebSocket = function (t, e) {
                                var r;
                                return r = null != e ? new z(t, e) : new z(t), X("socket") && n.trigger("request", {
                                    type: "socket",
                                    url: t,
                                    protocols: e,
                                    request: r
                    ...
                    return et(e, t), e
                }(h), K = null, W = function (t) {
                    var e, n, r, o;
                    for (o = E.ajax.ignoreURLs, n = 0, r = o.length; n < r; n++) if ("string" == typeof (e = o[n])) {
                    ...
                    var e, n, r, o, s;
                    if (o = t.type, r = t.request, s = t.url, !W(s)) return f.running || !1 === E.restartOnRequestAfter && "force" !== X(o) ? void 0 : (n = arguments, "boolean" == typeof (e = E.restartOnRequestAfter || 0) && (e = 0), setTimeout(function () {
                        var t, e, s, a, u;
                    ...
                    return t.prototype.watch = function (t) {
                        var e, n, r, o;
                        if (r = t.type, e = t.request, o = t.url, !W(o)) return n = "socket" === r ? new v(e) : new w(e), this.elements.push(n)
                    }, t
                }(), w = function (t) {
                    ...
                    var e, n, r, o;
                    for (null == t && (t = {}), this.elements = [], null == t.selectors && (t.selectors = []), o = t.selectors, n = 0, r = o.length; n < r; n++) e = o[n], this.elements.push(new l(e))
                }, l = function () {
                    function t(t) {
                    ...
                    this.progress = 0, t = 0, o = [], r = 0, n = A(), e = setInterval(function () {
                        var s;
                        return s = A() - n - 50, n = A(), o.push(s), o.length > E.eventLag.sampleCount && o.shift(), t = k(o), ++r >= E.eventLag.minSamples && t < E.eventLag.lagThreshold ? (i.progress = 100, clearInterval(e)) : i.progress = 3 / (t + 3) * 100
                    }, 50)
                }, y = function () {
                    function t(t) {
                ...
                }), m = {ajax: i, elements: u, document: a, eventLag: c}, (_ = function () {
                    var t, e, n, r, o, i, a, u;
                    for (f.sources = H = [], e = 0, r = (i = ["ajax", "elements", "document", "eventLag"]).length; e < r; e++) !1 !== E[t = i[e]] && H.push(new m[t](E[t]));
                    for (u = null != (a = E.extraSources) ? a : [], n = 0, o = u.length; n < o; n++) D = u[n], H.push(new D(E));
                    ...
                    var t;
                    return f.running = !0, S.render(), t = A(), L = !1, b = F(function (e, n) {
                        var r, o, i, s, a, u, l, c, p, h, d, g, m, v, w;
                        for (S.progress, o = h = 0, i = !0, u = d = 0, m = H.length; d < m; u = ++d) for (D = H[u], p = null != U[u] ? U[u] : U[u] = [], a = null != (w = D.elements) ? w : [D], l = g = 0, v = a.length; g < v; l = ++g) s = a[l], c = null != p[l] ? p[l] : p[l] = new y(s), i &= c.done, c.done || (o++, h += c.tick(e));
